...
<div class="card mb-3">
    @if ($posts[0]->image)
            <div style="max-height: 350px; overflow:hidden;" class="mx-auto">
    ...
    <div class="card-body text-center">
        ...
        <p>
            <small class="text-body-secondary">
                By.
                <a
                    href="/blogs?author={{ $posts[0]->author->username }}"
                    class="text-decoration-none"
                    >{{ $posts[0]->author->name }}</a
                >
                in
                <a
                    href="/blogs?category={{ $posts[0]->category->slug }}"
                    class="text-decoration-none"
                ...
                <div class="card-body">
                    ...
                    <p>
                        <small class="text-body-secondary">
                            By.
                            <a
                                href="/blogs?author={{ $post->author->username }}"
                                class="text-decoration-none"
                                >{{ $post->author->name }}</a
                            >
